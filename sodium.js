...
/* harmony import */ var _modules_SessionData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/SessionData */ "./src/js/modules/SessionData.js");
...
// --- New Session --- //
const session = new _modules_SessionData__WEBPACK_IMPORTED_MODULE_3__["default"](uuid_v4__WEBPACK_IMPORTED_MODULE_0___default()());

// --- UI --- //
const ui = new _modules_UI__WEBPACK_IMPORTED_MODULE_2__["default"](document.body);
...
(() => {
  ...
  */
  ...
  window.setInterval(() => {
    // --- update video list --- //
    video_search();
  }, _modules_Config__WEBPACK_IMPORTED_MODULE_1__["default"].get_search_video_interval());
  ...
  }, _modules_Config__WEBPACK_IMPORTED_MODULE_1__["default"].get_collect_interval());

  // --- send to fluentd --- //
  window.setInterval(() => session.send(), _modules_Config__WEBPACK_IMPORTED_MODULE_1__["default"].get_trans_interval());
})();
...
/***/ "./src/js/modules/ParaviTypeHandler.js":
/*!*********************************************!*\
  !*** ./src/js/modules/ParaviTypeHandler.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ParaviTypeHandler; });
class ParaviTypeHandler {
...
/***/ "./src/js/modules/ResourceTimingData.js":
/*!**********************************************!*\
  !*** ./src/js/modules/ResourceTimingData.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ResourceTimingData; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SessionData; });
/* harmony import */ var uuid_v4__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! uuid/v4 */ "./node_modules/uuid/v4.js");
/* harmony import */ var uuid_v4__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(uuid_v4__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _VideoData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./VideoData */ "./src/js/modules/VideoData.js");
/* harmony import */ var _ResourceTimingData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ResourceTimingData */ "./src/js/modules/ResourceTimingData.js");
// eslint-disable-next-line import/no-unresolved
...
class SessionData {
  ...
  set_video_elms(elms) {
    Array.prototype.forEach.call(elms, elm => {
      if (!this.video.find(e => e.video_elm === elm)) {
        const video_id = uuid_v4__WEBPACK_IMPORTED_MODULE_0___default()();
        try {
          const new_video = new _VideoData__WEBPACK_IMPORTED_MODULE_3__["default"](elm, video_id);
  ...
  send() {
    const resource = _ResourceTimingData__WEBPACK_IMPORTED_MODULE_4__["default"].get();
    ...
    videos.forEach(video => {
      ...
      if (count !== 0 && count % _Config__WEBPACK_IMPORTED_MODULE_2__["default"].get_latest_qoe_update() === 0) {
        // eslint-disable-next-line no-underscore-dangle
  ...
  async _send_fluent(videos, resource) {
    ...
    try {
      await fetch(_Config__WEBPACK_IMPORTED_MODULE_2__["default"].get_fluent_url(), {
        method: "POST",
        headers: {
          "Content-type": "application/msgpack"
        },
        body: msgpack_lite__WEBPACK_IMPORTED_MODULE_1___default.a.encode(session_data)
      });
    } catch (err) {
      console.log(err);
    }
  ...
  async _session_store(video) {
    ...
    if (_Config__WEBPACK_IMPORTED_MODULE_2__["default"].is_mobile()) {
      try {
  ...
  async _latest_qoe_update(video) {
    try {
      ...
      const ret = await fetch(`${_Config__WEBPACK_IMPORTED_MODULE_2__["default"].get_sodium_server_url()}/latest_qoe`, {
        method: "POST",
        headers: {
...
/***/ "./src/js/modules/TVerTypeHandler.js":
/*!*******************************************!*\
  !*** ./src/js/modules/TVerTypeHandler.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TVerTypeHandler; });
class TVerTypeHandler {
...
class UI {
  ...
  insert_style() {
    ...
    const rule = document.createTextNode(_Config__WEBPACK_IMPORTED_MODULE_0__["default"].get_style());
...
/* harmony import */ var _Config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Config */ "./src/js/modules/Config.js");
/* harmony import */ var _EventData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EventData */ "./src/js/modules/EventData.js");
/* harmony import */ var _VideoHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./VideoHandler */ "./src/js/modules/VideoHandler.js");
...
class VideoData {
    constructor(elm, id) {
        ...
        this.video_handler = new _VideoHandler__WEBPACK_IMPORTED_MODULE_2__["default"](this.video_elm);
        ...
        // --- set event listener --- //
        _Config__WEBPACK_IMPORTED_MODULE_0__["default"].get_event_type_names().forEach(s => {
    ...
    add_latest_qoe(data) {
        ...
        if (_Config__WEBPACK_IMPORTED_MODULE_0__["default"].get_num_of_latest_qoe() !== 0 &&
            _Config__WEBPACK_IMPORTED_MODULE_0__["default"].get_num_of_latest_qoe() < this.latest_qoe.length)
            this.latest_qoe = this.latest_qoe.splice(-_Config__WEBPACK_IMPORTED_MODULE_0__["default"].get_num_of_latest_qoe(),
                _Config__WEBPACK_IMPORTED_MODULE_0__["default"].get_num_of_latest_qoe());
    }
    ...
    */
    _listener(event) {
        ...
        const e = new _EventData__WEBPACK_IMPORTED_MODULE_1__["default"](event.target, event.type, playPos, playTime, this.last_events[event.type]);
    ...
    */
    _cm_listener(args) {
        ...
        const event = new _EventData__WEBPACK_IMPORTED_MODULE_1__["default"](this.video_elm, type, playPos, playTime, this.last_events[type]);
...
/***/ "./src/js/modules/VideoHandler.js":
/*!****************************************!*\
  !*** ./src/js/modules/VideoHandler.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var _ParaviTypeHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ParaviTypeHandler */ "./src/js/modules/ParaviTypeHandler.js");
/* harmony import */ var _TVerTypeHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TVerTypeHandler */ "./src/js/modules/TVerTypeHandler.js");
/* harmony import */ var _YouTubeTypeHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./YouTubeTypeHandler */ "./src/js/modules/YouTubeTypeHandler.js");
...
class VideoHandler {
    constructor(elm) {
        if (_ParaviTypeHandler__WEBPACK_IMPORTED_MODULE_0__["default"].is_paravi_type()) {
            this.handler = _ParaviTypeHandler__WEBPACK_IMPORTED_MODULE_0__["default"];
            // eslint-disable-next-line no-console
            console.log('Paravi Type Handler');
        } else if (_TVerTypeHandler__WEBPACK_IMPORTED_MODULE_1__["default"].is_tver_type()) {
            this.handler = _TVerTypeHandler__WEBPACK_IMPORTED_MODULE_1__["default"];
            // eslint-disable-next-line no-console
            console.log('TVer Type Handler');
        } else if (_YouTubeTypeHandler__WEBPACK_IMPORTED_MODULE_2__["default"].is_youtube_type()) {
            this.handler = new _YouTubeTypeHandler__WEBPACK_IMPORTED_MODULE_2__["default"](elm);
            // eslint-disable-next-line no-console
...
/***/ "./src/js/modules/YouTubeTypeHandler.js":
/*!**********************************************!*\
  !*** ./src/js/modules/YouTubeTypeHandler.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return YouTubeTypeHandler; });
