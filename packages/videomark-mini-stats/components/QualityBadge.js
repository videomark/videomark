...
export const QualityBadge = ({ label, quality, ...props }) => (React.createElement("g", Object.assign({}, props),
    ...
    React.createElement(JPText, { x: 196, y: 22, dominantBaseline: "middle", fontSize: 24, fontWeight: "bold", fill: "#ffffff" }, Number.isFinite(quality) ? clampQuality(quality).toFixed(1) : "n/a"),
