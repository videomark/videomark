...
export const Badge = ({ label, message, ...props }) => (React.createElement("g", Object.assign({}, props),
    ...
    React.createElement(JPText, { x: 160 / 2, y: 20, textAnchor: "middle", dominantBaseline: "middle", fontSize: 24, fill: "#ffffff" }, label),
    React.createElement("rect", { x: 160, width: width - 160, height: 40, fill: messageColor }),
    React.createElement(JPText, { x: 160 + (width - 160) / 2, y: 20, width: 160, textAnchor: "middle", dominantBaseline: "middle", fontSize: 24, fontWeight: "bold", fill: "#ffffff" }, message)));
