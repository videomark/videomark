...
export function underQuotaLimit() {
  return Config.get_settings().control_by_traffic_volume && Config.get_transfer_size().limit_started;
};
...
export function underPeakTimeLimit() {
  return Config.get_settings().peak_time_limit_enabled && Config.get_peak_time_limit().limit_started;
};
