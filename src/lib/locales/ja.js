export const strings = {
  ...
  onboarding: {
    ...
    visualize: {
      ...
      description:
        'YouTube、Netflix などの対応サイトを開いて、普段通りに動画を見てください。動画の左上に表示されるオーバーレイに再生品質に関する様々な統計情報が表示され、ネット環境の優劣を知る手がかりとなります。',
    },
    dropdown: {
      title: '最近見た動画に<wbr>すばやく戻れる',
      description:
        'ブラウザーのツールバーに VideoMark ボタンを追加すれば、最近見た動画を簡単に見ることができます。履歴を提供していない動画サイトでは特に便利な機能です。',
    },
    history: {
  ...
  history: {
    ...
    detail: {
      ...
      showLiveStats: 'ライブ統計を表示',
      hideLiveStats: 'ライブ統計を隠す',
      viewHistory: '履歴を見る',
      viewingHistory: '視聴履歴',
      delete: '削除',
      deleteAll: 'すべて削除',
  ...
  stats: {
    ...
    quality: {
      ...
      frameDrops: 'フレームドロップが発生したため、実際の体感品質とは異なる可能性があります。',
      newerCodec:
        '比較的新しい動画コーデックが使われているため、実際の体感品質とは異なる可能性があります。',
    },
  },
  settings: {
